# Carte des sources du Guide Parents

| Section | Sources du snapshot | Règle |
| --- | --- | --- |
| Couverture | `/campaign`, `/levels`, `/subjects`, `/contact`, `/cta` | aucune provenance technique visible |
| L’essentiel | `/campaign`, `/offers`, `/offerPricing`, `/schedule` | quatre niveaux et deux gammes |
| Fondations / Premium | `/offers`, `/campaign/capacityByOffer`, `/capabilities` | capacité non engagée exclue |
| Pourquoi une pré-rentrée | `/content/method`, `/modules`, bloc éditorial sourcé | aucun résultat garanti |
| Méthode Nexus | `/content/method`, `/pedagogy`, `/capabilities` | formulation sobre tant que les workflows ne sont pas opérationnels |
