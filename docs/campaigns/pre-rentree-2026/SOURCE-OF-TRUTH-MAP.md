...
| --- | --- | --- | --- | --- | --- |
| Dates, pause, lieu, statuts | `data/campaigns/pre-rentree-2026.json` | Campagne | `2.0.1` | site, snapshot, documents | schéma et tests de dates |
| Quatre niveaux et cinq familles de matières | même source, `levels`, `subjects` | Pédagogie | `2.0.1` | site, Guide, planning | compte et intégrité des références |
| Quatorze créneaux, salles et gates | même source, `blocks`, `schedule`, `operationalGates` | Exploitation | `2.0.1` | planning REVIEW | 70 séances, conflits et blocage de publication |
| Capacités Fondations/Premium | même source, `capacityByOffer` | Direction | `2.0.1` | site, documents, économie | 4–6 et 3–5 |
| Demande, qualification, réservation | même source, `content`, `cta` | Direction | `2.0.1` | Guide, FAQ, site | vocabulaire et absence de paiement public |
...
| Structure du Guide | `content/pre-rentree-2026/parent-guide.fr.json` | Éditorial | `2026-parent-guide-fr-v3` | renderer | schéma fermé et evidence refs |
