...
| Quatre blocs, trois fenêtres, cohortes et gates | même source, `blocks`, `schedule`, `operationalGates` | Exploitation | `2.1.0` | planning public sanitizé et exports internes | 16 cohortes, 80 occurrences, conflits et blocage de publication |
...
| Seize cohortes et quatre-vingts occurrences | `data/campaigns/pre-rentree-2026.json#/schedule` | Exploitation | `2.1.0` | planning, sélecteur, PDF | 16 × 5 occurrences sans double comptage pédagogique |
