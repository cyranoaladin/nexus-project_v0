# Maquette du bilan — version destinée aux responsables légaux

> **Jeu de données fictif.** Candidat `CL-2026-0001`, aucune passation réelle, aucun élément nominatif. Ce document montre, règle par règle, la donnée d'entrée, la règle citée et le résultat obtenu. Il n'est pas le bilan : c'est sa dérivation.

> **Destinataire.** Cette version s'adresse aux responsables légaux d'un candidat mineur. Elle porte exactement les mêmes valeurs que la version remise au candidat et au coach : seuls le destinataire et le registre changent, jamais un chiffre.

## Entrée — ce dont on part

- Profil **P3**, session **2027**, statut **mineur**
