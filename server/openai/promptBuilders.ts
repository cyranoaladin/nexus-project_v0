import { z } from "zod";
import { QcmSummary, Volet2Summary, Variant, StudentMeta } from 'packages/shared/types/bilan';
...
export function buildMessages(opts: {
  ...
  return [
    ...
    { role: "user", content: `Génère le rapport en JSON basé sur les instructions suivantes : ${JSON.stringify(instructions)}` },
  ] as const;
}
