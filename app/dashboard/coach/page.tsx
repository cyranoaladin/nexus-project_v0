          ...
          <>
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                Bonjour {data?.coach.pseudonym} ! 👨‍🏫
              </h2>
              <p className="text-gray-600">
                Voici votre tableau de bord pour gérer vos sessions et suivre vos élèves.
              </p>
              <div className="flex flex-wrap gap-2 mt-3">
                {data?.coach.specialties?.map((specialty: string, index: number) => (
                    ...
                    <div className="space-y-4">
                      {data.students.map((student, index) => (
                        ...
                        >
                          ...
                          <div className="flex items-center space-x-2">
                            <Link href={`/dashboard/coach/students/${student.id}`}>
                              <Button variant="outline" size="sm" className="whitespace-nowrap">
                                {student.isNew ? 'Planifier la 1ère session' : 'Voir le profil'}
                              </Button>
                            </Link>
                          </div>
                        </div>
