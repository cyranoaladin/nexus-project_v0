  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          variant={currentPlan === 'AUCUN' ? 'default' : 'outline'}
          size="sm"
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <p className="text-sm text-gray-600 bg-gray-50 p-2 rounded-lg">{currentPlan}</p>
          </div>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => setFormData({ ...formData, newPlan: value })}
            >
              <SelectTrigger>
          ...
          <div className="bg-blue-50 p-3 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p>
                  Votre demande sera envoyée à l'assistant pour approbation. Le changement sera
                  effectif après validation.
                </p>
              </div>
            </div>
          </div>
