                  ...
                  <div className="flex space-x-2">
                    <Dialog>
                      ...
                      <DialogContent>
                        ...
                        <DialogDescription className="sr-only">Fenêtre affichant les détails d'une demande de crédits</DialogDescription>
                        <div className="space-y-4">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Dialog>
                              ...
                              <DialogContent>
                                ...
                                <DialogDescription className="sr-only">Fenêtre de rejet de la demande de crédits</DialogDescription>
                                <div className="space-y-4">
                                  <div>
