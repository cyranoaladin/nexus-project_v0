    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => fetchCreditRequests()} className="mt-4">
            Réessayer
          </Button>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h1 className="font-semibold text-gray-900">Gestion des Demandes de Crédits</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Demandes de Crédits</h2>
              <p className="text-gray-600">Gérez les demandes d'achat de crédits des parents</p>
            </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-lg">
                        Demande de {request.amount} crédits - {request.student.firstName}{' '}
                    ...
                    <Dialog>
                      ...
                      <DialogContent>
                        ...
                        <DialogDescription className="sr-only">
                          Fenêtre affichant les détails d'une demande de crédits
                        </DialogDescription>
                        <div className="space-y-4">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Dialog>
                              ...
                              <DialogContent>
                                ...
                                <DialogDescription className="sr-only">
                                  Fenêtre de rejet de la demande de crédits
                                </DialogDescription>
                                <div className="space-y-4">
                                  <div>
