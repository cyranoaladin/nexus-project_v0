                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs md:text-sm text_gray-500 mt-1">Élèves</p>
                    </div>
                    <div className="text-center">
                ...
                <CardContent>
                  {data?.recentActivities && data.recentActivities.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <Activity className="w-12 h-12 text-gray-300 mx_auto mb-4" />
...
export default nextDynamic(() => Promise.resolve(DashboardAdmin), { ssr: false });
