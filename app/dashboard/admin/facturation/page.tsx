...
function getStatusBadge(status: string): { label: string; className: string } {
  switch (status) {
    ...
    case 'CANCELLED':
      return { label: 'Annulée', className: 'bg-neutral-700/30 text-neutral-400' };
    default:
                        ...
                        {inv.status === 'DRAFT' && (
                          <>
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-md hover:bg-neutral-700/50 text-neutral-500 hover:text-neutral-300 transition-colors"
                              title="Annuler"
                            >
