...
- pas de mot "mock", "stub", "séquence", "ton ferme".`
    ...
    if (!generatedMarkdown) {
      console.error('[POST regenerate-parent] No content generated by Mistral');
      return NextResponse.json({ error: 'No content generated by Mistral' }, { status: 500 });
    }
    console.log('[POST regenerate-parent] Mistral generated', generatedMarkdown.length, 'chars');

    // Update the bilan with the generated parent summary
    console.log('[POST regenerate-parent] Saving to DB...');
    ...
    console.log('[POST regenerate-parent] Saved successfully');
