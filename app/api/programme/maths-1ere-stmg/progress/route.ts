...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error('[API] Failed to persist Première STMG progress:', serializeError(error));
...
export async function GET() {
  ...
  try {
    ...
    console.error('[API] Failed to load Première STMG progress:', serializeError(error));
