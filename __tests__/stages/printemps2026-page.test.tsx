...
describe('Stages page — 2026/2027', () => {
  it('renders the page shell with the active stages copy', () => {
    ...
    // The expired campaign is closed; future calendar entries stay available.
    expect(screen.queryByRole('heading', { name: 'Pré-rentrée 2026 en première position' })).not.toBeInTheDocument();
    expect(screen.queryByRole('link', { name: /Découvrir la Pré.?rentrée 2026/i })).not.toBeInTheDocument();
