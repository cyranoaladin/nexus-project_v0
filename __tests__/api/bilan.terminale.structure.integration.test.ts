...
describe('questionnaire-structure Terminale Maths', () => {
  it('renvoie QCM Terminale et Volet2 fusionné', async () => {
    const mod = await import('@/app/api/bilan/questionnaire-structure/route');
    const url = new URL('http://localhost/api/bilan/questionnaire-structure?matiere=MATHEMATIQUES&niveau=terminale&studentId=e2e');
    // @ts-ignore
