...
const EXPECTED_TRANSITIONS = new Set([
  ...
  'TECHNICAL_ACTION_REQUIRED:ASSESSMENT_SUBMITTED:WORKER',
  'TECHNICAL_ACTION_REQUIRED:SCORED:WORKER',
  ...BILAN_REQUEST_STATUSES
...
describe('bilan request state machine', () => {
  ...
  it('uses explicit conservative actors for intervention and retry transitions', () => {
    ...
    expect(transition('TECHNICAL_ACTION_REQUIRED', 'ASSESSMENT_SUBMITTED', 'WORKER')).toBeDefined();
    expect(transition('TECHNICAL_ACTION_REQUIRED', 'SCORED', 'WORKER')).toBeDefined();
    expect(transition('TECHNICAL_ACTION_REQUIRED', 'ASSESSMENT_SUBMITTED', 'ASSISTANTE')).toBeUndefined();
    expect(transition('TECHNICAL_ACTION_REQUIRED', 'ASSESSMENT_SUBMITTED', 'ADMIN')).toBeUndefined();
    expect(transition('TECHNICAL_ACTION_REQUIRED', 'SCORED', 'ASSISTANTE')).toBeUndefined();
    expect(transition('TECHNICAL_ACTION_REQUIRED', 'SCORED', 'ADMIN')).toBeUndefined();
