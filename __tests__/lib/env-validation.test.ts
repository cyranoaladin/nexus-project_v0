...
describe('validateEnv', () => {
  ...
  describe('OPTIONAL vars', () => {
    it('does not warn for missing OPTIONAL vars', () => {
      ...
      process.env.RAG_API_BASE_URL = 'https://rag.example.com';
      process.env.RAG_BFF_SERVICE_TOKEN = 'b'.repeat(32);
      process.env.RAG_ENGINE_API_KEY = 'k'.repeat(32);
      process.env.NEXUS_INTERNAL_TOKEN_SECRET = 's'.repeat(32);
      process.env.NEXUS_INTERNAL_TOKEN_ISSUER = 'nexus-cockpit';
      process.env.NEXUS_INTERNAL_TOKEN_AUDIENCE = 'nexus-rag';
      process.env.NEXUS_SSO_ISSUER = 'nexus-cockpit';
      process.env.NEXUS_SSO_AUDIENCE = 'nexus-rag';
