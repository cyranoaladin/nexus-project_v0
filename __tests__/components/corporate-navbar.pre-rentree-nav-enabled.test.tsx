...
// Proves the flip described in lib/campaigns/pre-rentree-2026/release-gate.ts:
// turning canShowPreRentreeInPermanentNav() on is the entire diff needed to
...
jest.mock('@/lib/campaigns/pre-rentree-2026/release-gate', () => ({
  ...
  canShowPreRentreeInPermanentNav: () => true,
}));

describe('CorporateNavbar with canShowPreRentreeInPermanentNav() enabled', () => {
  beforeEach(() => {
