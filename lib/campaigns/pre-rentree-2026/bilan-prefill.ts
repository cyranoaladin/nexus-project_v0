...
const SUBJECT_IDS = ['MATHEMATIQUES', 'PHYSIQUE_CHIMIE', 'NSI', 'FRANCAIS', 'PHILOSOPHIE', 'SVT', 'SES', 'EMC', 'HISTOIRE_GEOGRAPHIE'] as const;
const PACK_CODES = [
  'PACK_1',
  'PACK_2',
  'PACK_3',
...
const TERMINALE_SPECIALTY_IDS = ['MATHEMATIQUES', 'PHYSIQUE_CHIMIE', 'NSI', 'SVT', 'SES', 'HISTOIRE_GEOGRAPHIE'] as const;
