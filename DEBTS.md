...
| **B-7** | **R1 — grille tarifs/effectifs à arbitrer (BLOQUANT)** | Écart entre ta grille énoncée (3-5 partout, acomptes 140/410) et la prod déployée `d0ce2241` (Fondations **4-6**, acomptes **144/405**, exception signée DIRECTION 2026-07-20). Mes changements (group_max 6→5, propagation « 4 à 6 »→« 4 à 5 ») **revertés au réel production**. **Ton arbitrage requis** avant tout changement d'offre — détail : `P0_REGRESSIONS.md`. |
