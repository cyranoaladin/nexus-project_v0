        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-blue-300 mb-4 md:mb-6 max-w-md text-sm md:text-base">
              La plateforme de{' '}
              <span className="text-blue-300 font-semibold">pédagogie augmentée</span> de référence
              pour la <span className="text-blue-300 font-semibold">réussite au Baccalauréat</span>{' '}
              et l'<span className="text-blue-300 font-semibold">excellence à Parcoursup</span>.
            </p>
