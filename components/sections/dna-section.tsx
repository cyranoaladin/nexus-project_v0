...
export default function DNASection() {
  return (
    <section id="adn" className="relative py-24 bg-surface-darker">
      <div className="absolute inset-0">
        <div className="absolute left-1/3 top-0 h-72 w-72 rounded-full bg-brand-accent/5 blur-[120px]" />
        <div className="absolute right-1/3 bottom-0 h-72 w-72 rounded-full bg-neutral-800/20 blur-[120px]" />
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-brand-accent/30 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-brand-accent backdrop-blur-md">
            Notre ADN Unique
          </div>
          <h2 className="mt-4 text-3xl md:text-5xl font-bold text-white font-display">
        ...
        <div className="relative grid gap-8 lg:grid-cols-2">
          <div className="absolute left-1/2 top-8 hidden h-[80%] w-px -translate-x-1/2 bg-gradient-to-b from-brand-accent/0 via-brand-accent/30 to-brand-accent/0 lg:block" />
