      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-900 max-w-3xl mx-auto">
            La solution annuelle tout-en-un pour préparer le{' '}
            <span className="text-blue-600 font-semibold">Baccalauréat</span> en candidat libre avec
            la structure, le soutien et l'expertise d\'un établissement d\'excellence.
          </p>
        </motion.div>
            ...
            <CardContent className="space-y-8">
              ...
              <div className="text-center">
                <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 font-semibold">
                  <Link href="/contact">Demander un entretien</Link>
                </Button>
