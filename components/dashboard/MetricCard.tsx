...
const VARIANT_STYLES: Record<string, { bg: string; border: string; text: string }> = {
  ...
  warning:  { bg: 'from-blue-500/20 to-blue-500/5', border: 'border-blue-500/30', text: 'text-blue-300' },
  danger:   { bg: 'from-slate-500/20 to-slate-500/5', border: 'border-slate-500/30', text: 'text-slate-300' },
};
