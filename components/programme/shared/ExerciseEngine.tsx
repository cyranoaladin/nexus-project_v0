...
import type { Exercice, ExerciceQCM, ExerciceNumerique, ExerciceOrdonnancement } from '@/components/programme/shared/types/programme';
...
function NumericExercise({
  ...
  onCorrect: () => void;
  areEquivalentAnswers: (answer: string, expected: string) => boolean;
}) {
...
export default function ExerciseEngine({
  ...
  return (
    <div className="bg-slate-900 rounded-2xl p-6 border border-slate-700">
      ...
      {ex.type === 'numerique' && (
        <NumericExercise exercice={ex} onCorrect={handleCorrect} areEquivalentAnswers={areEquivalentAnswers} />
      )}
