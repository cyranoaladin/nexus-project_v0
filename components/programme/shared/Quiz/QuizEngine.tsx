...
export const QuizEngine: React.FC<QuizEngineProps> = ({ onSwitchTab, store, quizData }) => {
  ...
  const categoryList = Array.from(new Set(quizData.map((q: QuizQuestion) => q.categorie))).sort();
