          ...
          <div className="rounded-2xl border border-slate-700/40 bg-slate-900/40 p-6">
            ...
            <div className="space-y-4 text-sm text-slate-300 leading-relaxed">
              <div>
                ...
                <p>
                  {displayName} a suivi le stage de printemps Nexus Réussite du {stageConfig.STAGE_PRINTEMPS_2026.debut} au {stageConfig.STAGE_PRINTEMPS_2026.fin}, soit{' '}
                  <strong className="text-white">{stageConfig.STAGE_PRINTEMPS_2026.heuresMaths} heures de mathématiques</strong> en présentiel.
              ...
              <div>
                ...
                <div className="space-y-1">
                  {stageConfig.STAGE_PRINTEMPS_2026.promessesNexus.slice(0, 5).map((p: string, i: number) => (
