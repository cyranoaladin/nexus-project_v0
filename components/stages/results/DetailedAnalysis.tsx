  ...
  return (
    <div className={`rounded-xl border p-4 ${config.bg} ${config.border} print:break-inside-avoid`}>
      ...
      <div className="flex items-center gap-4 text-xs">
        <span className="text-blue-700 font-semibold inline-flex items-center gap-1"><CheckCircle2 className="h-3.5 w-3.5" aria-hidden="true" />{cat.correctAnswers}</span>
        <span className="text-slate-700 font-semibold inline-flex items-center gap-1"><XCircle className="h-3.5 w-3.5" aria-hidden="true" />{cat.incorrectAnswers}</span>
