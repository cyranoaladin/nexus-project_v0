...
export default function Volet2Form({ schema }: { schema: Volet2Schema; }) {
  ...
  const onSubmit = (data: any) => {
    const exportPayload = normalizeVolet2(data);
    console.log("Volet2 exportPayload:", exportPayload);
    setTimeout(() => alert("Réponses enregistrées. Ouvrir la console pour voir le payload."), 50);
  };
